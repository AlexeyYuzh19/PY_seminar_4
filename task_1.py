...
'''
Решение.
Программа запрашивает у пользователя – выбрать способ ввода набора чисел: вручную с клавиатуры или в 2 вариантах рандомно.
...
целых чисел и выводится последовательность – вместо неверно введенных значений указывается что введено. 
...
Результат - вывод без повторений в порядке возрастания все те числа, которые встречаются в обоих наборах целых чисел 
(либо из введенных пользователем с клавиатуры, либо сгенерированных рандомно). 
